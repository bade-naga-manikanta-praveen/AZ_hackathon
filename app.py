...
i=0
# extracting data
with open("web scraping/question_name.txt", 'r', encoding='latin-1') as f:
   for line in f:
      i+=1
      text=line.strip()
...
with open("web scraping/question_index_with_link.txt", 'r', encoding='latin-1') as f:
   for line in f:
      text=line.strip()
      extracted_question_link=text.split('.',1)[-1]
      Q_link.append(extracted_question_link)

with open("web scraping/question_difficulty.txt", 'r', encoding='latin-1') as f:
   for line in f:
